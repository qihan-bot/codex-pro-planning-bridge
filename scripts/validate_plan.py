"""Compatibility exports for the unified Plan Validator."""
...
from codex_pro_planning_bridge.validator import *  # noqa: E402,F401,F403
...
def main(argv: list[str] | None = None) -> int:
    ...
    return cli_main(["validate", *values])
