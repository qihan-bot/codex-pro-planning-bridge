"""Human-controlled ChatGPT handoff helpers."""
...
def open_chat(
    ...
    *,
    ...
    browser: object = webbrowser,
) -> int:
    """Copy REQUEST.md, open ChatGPT, and leave submission to the user."""
    ...
    clipboard_tool = clipboard(content)
    browser.open(url, new=2)  # type: ignore[attr-defined]
